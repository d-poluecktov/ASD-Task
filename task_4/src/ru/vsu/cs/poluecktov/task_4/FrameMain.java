...
public class FrameMain extends JFrame {
    ...
    private JButton buttonSortStudents;
    ...
    public FrameMain() {
        ...
        tableInput.setTableHeader(new JTableHeader());



        JTableUtils.initJTableForArray(tableInput, 200, true, true, true, false);
        ...
        buttonSortStudents.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String[][] matrix = JTableUtils.readStringMatrixFromJTable(tableInput);
                List<Student> list = Task.getStudentList(matrix);
                Collections.sort(list);
                String[][] answer = Task.getStudentArray(list);
