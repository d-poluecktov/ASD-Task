...
import ru.vsu.cs.poluecktov.task_6.dummy.DefaultNotSupportedCollection;
import ru.vsu.cs.poluecktov.task_6.dummy.DefaultNotSupportedSet;
import ru.vsu.cs.poluecktov.task_6.dummy.DefaultNotSupportedSortedMap;
...
public interface BSTreeMap<K extends Comparable<? super K>, V> extends DefaultNotSupportedSortedMap<K, V> {
    ...
    class MapTreeEntry<K extends Comparable<? super K>, V> implements Entry<K, V>, Comparable<MapTreeEntry<K, V>> {
    ...
    RndBSTree<MapTreeEntry<K, V>> getTree();
   ...
   @Override
    default V get(Object key) {
       MapTreeEntry<K, V> entry = null;
       try {
           entry = getTree().get(new MapTreeEntry((K) key, null));
       } catch (Exception e) {
           e.printStackTrace();
       }
