...
public class BinaryTreePainter {
    ...
    private static <T extends Comparable<T>> NodeDrawResult paint(BinaryTreeInterface.TreeNode<T> node, Graphics2D g2d, int x, int y) {
        if (node == null) {
            return null;
        }
     ...
     */
    public static <T extends Comparable<T>> Dimension paint(BinaryTreeInterface<T> tree, Graphics gr) {
     ...
     */
    public static <T extends Comparable<T>> void saveIntoFile(BinaryTreeInterface<T> tree, String filename, boolean backgroundTransparent)
            throws IOException {
     ...
     * @throws IOException Возможное исключение
     */
    public static <T extends Comparable<T>> void saveIntoFile(BinaryTreeInterface<T> tree, String filename)
            throws IOException {
